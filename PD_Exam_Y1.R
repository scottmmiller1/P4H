...
dta <- read.csv("/Users/scottmiller/Desktop/P4H Global/Evaluation/Analysis/PD/PD_20/Year 1/Data/PD_20 Exam Data Full.csv")
library(tidyverse)
...
dta1 <- filter(dta1, dta1$School == "RMI") # change for each school
